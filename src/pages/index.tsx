      ...
      <div className="relative z-10 text-center max-w-5xl w-full">
        ...
        <div className="mb-20 animate-fade-in-up">
          <div className="inline-flex items-center justify-center w-24 h-24 mb-10 relative group">
            ...
            {/* Logo容器 - 更精致的渐变和阴影 */}
            <div className="relative bg-gradient-to-br from-teal-500 via-teal-400 to-cyan-500 rounded-3xl p-5 shadow-[0_20px_60px_-15px_rgba(20,184,166,0.4)] transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
